...
#ifndef POINT_TO_POINT_WIRELESS_HELPER_H
#define POINT_TO_POINT_WIRELESS_HELPER_H
 ...
 * "mixins".
 */
class PointToPointWirelessHelper : public PcapHelperForDevice,
...
public:
   ...
   * point networks.
   */
  PointToPointWirelessHelper ();
  virtual ~PointToPointWirelessHelper () {}
  ...
  void SetDelayAttribute (std::string n1, const AttributeValue &v1);
