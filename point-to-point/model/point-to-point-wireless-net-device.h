#ifndef POINT_TO_POINT_WIRELESS_NET_DEVICE_H
#define POINT_TO_POINT_WIRELESS_NET_DEVICE_H
...
class PointToPointWirelessChannel;
class ErrorModel;
 ...
 */
class PointToPointWirelessNetDevice : public NetDevice
{
public:
  /**
   ...
   */
  virtual ~PointToPointWirelessNetDevice ();
   ...
   */
  bool Attach (Ptr<PointToPointWirelessChannel> ch);
...
private:
   ...
   */
  PointToPointWirelessNetDevice& operator = (const PointToPointWirelessNetDevice &o);
   ...
   * \param o Other NetDevice
   */
  PointToPointWirelessNetDevice (const PointToPointWirelessNetDevice &o);
...
private:
   ...
   * attached.
   */
  Ptr<PointToPointWirelessChannel> m_channel;
